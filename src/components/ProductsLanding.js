        ...
        <div className="row">
          <div className="container py-5 mb-0">
            <div
              ...
              data-wow-delay="0.1s"
            >
              <h4 className="ff-secondary text-center test fw-semi-bold">
                Delicious meals from Adnegs Foods
              </h4>
              ...
              <ul className="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                <li className="nav-item">
                  <a
                    ...
                    href="#tab-1"
                  >
                    <FontAwesomeIcon icon={faCoffee} className="fa-3x test" />
                    <div className="ps-3">
                ...
                <li className="nav-item">
                  <a
                    ...
                    href="#tab-3"
                  >
                    <FontAwesomeIcon icon={faUtensils} className="fa-3x test" />
                    <div className="ps-3">
